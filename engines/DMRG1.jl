...
function verbosePrintDMRG1(s::Int64,i::Int64,currEigenVal::Float64,ϵ::Float64,tol::Float64,current_χ::Int64)
...
function DMRG1(mps::DMRG_types.MPS, env::DMRG_types.MPOEnvironments, model::DMRG_types.Model)
    ...
    for s = 1 : length(χ)
        ...
        for i = 1 : length(mps.ARs) - 1
            ...
            verbosePrintDMRG1(s,i,real(currEigenVal),ϵ[i],tol[i],current_χ[i])
        ...
        for i = length(mps.ARs) : -1 : 2
            ...
            verbosePrintDMRG1(s,i,real(currEigenVal),ϵ[i],tol[i],current_χ[i-1])
